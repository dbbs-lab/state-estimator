...
*/
class diff_neuron : public nest::Archiving_Node{
public:
  /**
...
private:
  ...
  friend class nest::RecordablesMap<diff_neuron>;
  friend class nest::UniversalDataLogger<diff_neuron>;
  ...
  */
  ...
  struct Buffers_ {
    ...
    nest::UniversalDataLogger<diff_neuron> logger_;
  ...
  */
  ...
  static nest::RecordablesMap<diff_neuron> recordablesMap_;
...
inline nest::port diff_neuron::send_test_event(
...
inline nest::port diff_neuron::handles_test_event(nest::SpikeEvent&, nest::port receptor_type){
...
inline nest::port diff_neuron::handles_test_event(
