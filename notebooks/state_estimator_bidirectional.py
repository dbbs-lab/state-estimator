...
# SIMULAZIONI
# post learning: target cervelletto 100 + target fbk 100 + variabilità cervelletto 0 + variabilità fbk 0
# pre learning: target cervelletto 0 + target fbk 100 + variabilità cervelletto 1 + variabilità fbk 0
# monodirectional: target cervelletto 0 + target fbk -100 + variabilità cervelletto 0 + variabilità fbk 0


# Cerebellum
# cerebellum_target 100 e variability 0;
# cerebellum_target 0 e variability 1
cerebellum_target = 100
...
cerebellum_target = 50
file_pattern = data_folder+'pattern_cerebellum_y.dat'
a_file = open(file_pattern, "w")
# Sinusoid
#pattern, pol = minimumJerk_ddt(np.array([0.0]), np.array([5e6]), time_vect)
# Sigmoid
...
# Y
sensory_target = 50 # 100
file_pattern = data_folder+'pattern_sensory_y.dat'
a_file = open(file_pattern, "w")
# Sinusoid
#pattern, pol = minimumJerk_ddt(np.array([0.0]), np.array([5e6]), time_vect)
# Sigmoid
...
sensory_input_y = Input_signal(n=n_neurons, pathData=data_folder, filename='pattern_sensory_y.dat', time_vect=time_vect, **params)
cerebellum_input_y = Input_signal(n=n_neurons, pathData=data_folder, filename='pattern_cerebellum_y.dat',time_vect=time_vect, **params)
...
w = 0.01*(24*variability + 1)
conv = (4 - n_neurons)*variability + n_neurons
feedback_neurons_p_y = nest.Create("diff_neuron",n = n_neurons)
nest.SetStatus(feedback_neurons_p_y, {"kp": 1.0, "pos": True, "buffer_size": 25.0, "base_rate": 0.0})
feedback_neurons_n_y = nest.Create("diff_neuron",n = n_neurons)
nest.SetStatus(feedback_neurons_n_y, {"kp": 1.0, "pos": False, "buffer_size": 25.0, "base_rate": 0.0})
syn_exc = {"weight": w, "delay": 1.0}
syn_inh = {"weight": -w, "delay": 1.0}
nest.Connect(sensory_input_y.pops_p.pop, feedback_neurons_p_y, {'rule': 'fixed_indegree','indegree': conv}, syn_spec=syn_exc)
nest.Connect(sensory_input_y.pops_n.pop, feedback_neurons_n_y, {'rule': 'fixed_indegree','indegree': conv}, syn_spec=syn_inh)
...
# variability = 0 => conv = n_neurons
# variability = 1 => conv = 5
cerebellar_neurons_p_y = nest.Create("diff_neuron",n = n_neurons)
nest.SetStatus(cerebellar_neurons_p_y, {"kp": 1.0, "pos": True, "buffer_size": 25.0, "base_rate": 0.0})
cerebellar_neurons_n_y = nest.Create("diff_neuron",n = n_neurons)
nest.SetStatus(cerebellar_neurons_n_y, {"kp": 1.0, "pos": False, "buffer_size": 25.0, "base_rate": 0.0})
syn_exc = {"weight": w, "delay": res}
syn_inh = {"weight": -w, "delay": res}
nest.Connect(cerebellum_input_y.pops_p.pop, cerebellar_neurons_p_y, {'rule': 'fixed_indegree','indegree': conv}, syn_spec=syn_exc)
nest.Connect(cerebellum_input_y.pops_n.pop, cerebellar_neurons_n_y, {'rule': 'fixed_indegree','indegree': conv}, syn_spec=syn_inh)
...
state_neurons_p_y = nest.Create("state_neuron", n_neurons)
nest.SetStatus(state_neurons_p_y, {"kp": 1.0, "pos": True, "buffer_size": 20.0, "base_rate": 0.0})
state_neurons_n_y = nest.Create("state_neuron", n_neurons)
nest.SetStatus(state_neurons_n_y, {"kp": 1.0, "pos": False, "buffer_size": 20.0, "base_rate": 0.0})
# Connect inputs
syn_1 = {"weight": 1.0, "receptor_type": 1}
syn_2 = {"weight": 1.0, "receptor_type": 2}
# Positive neurons
nest.Connect(cerebellar_neurons_p_y, state_neurons_p_y, "all_to_all", syn_spec=syn_1)
nest.Connect(feedback_neurons_p_y, state_neurons_p_y, "all_to_all", syn_spec=syn_2)
nest.SetStatus(state_neurons_p_y, {"num_first": float(n_neurons), "num_second": float(n_neurons)})
# Negative neurons
nest.Connect(cerebellar_neurons_n_y, state_neurons_n_y, "all_to_all", syn_spec=syn_1)
nest.Connect(feedback_neurons_n_y, state_neurons_n_y, "all_to_all", syn_spec=syn_2)
nest.SetStatus(state_neurons_n_y, {"num_first": float(n_neurons), "num_second": float(n_neurons)})
...
# Y
spikedetector_cer_pos_y = nest.Create("spike_detector", params={"withgid": True,"withtime": True,"to_file":True, "label": "Cerebellum Pos Y"})
nest.Connect(cerebellar_neurons_p_y, spikedetector_cer_pos_y)
spikedetector_cer_neg_y = nest.Create("spike_detector", params={"withgid": True,"withtime": True,"to_file":True, "label": "Cerebellum Neg Y"})
nest.Connect(cerebellar_neurons_n_y, spikedetector_cer_neg_y)
# Feedback
spikedetector_feedback_pos_y = nest.Create("spike_detector", params={"withgid": True,"withtime": True,"to_file":True, "label": "Feedback Pos Y"})
nest.Connect(feedback_neurons_p_y, spikedetector_feedback_pos_y)
spikedetector_feedback_neg_y = nest.Create("spike_detector", params={"withgid": True,"withtime": True,"to_file":True, "label": "Feedback Neg Y"})
nest.Connect(feedback_neurons_n_y, spikedetector_feedback_neg_y)
# State Estimator
spikedetector_state_pos_y = nest.Create("spike_detector", params={"withgid": True,"withtime": True,"to_file":True, "label": "State Pos Y"})
nest.Connect(state_neurons_p_y, spikedetector_state_pos_y)
spikedetector_state_neg_y = nest.Create("spike_detector", params={"withgid": True,"withtime": True,"to_file":True, "label": "State Neg Y"})
nest.Connect(state_neurons_n_y, spikedetector_state_neg_y)
...
# Y
dSD_cer_pos = nest.GetStatus(spikedetector_cer_pos_y, keys="events")[0]
evs_cer_pos_y = dSD_cer_pos["senders"]
ts_cer_pos_y = dSD_cer_pos["times"]
dSD_cer_neg = nest.GetStatus(spikedetector_cer_neg_y, keys="events")[0]
evs_cer_neg_y = dSD_cer_neg["senders"]
ts_cer_neg_y = dSD_cer_neg["times"]

dSD_feedback_pos = nest.GetStatus(spikedetector_feedback_pos_y, keys="events")[0]
evs_feedback_pos_y = dSD_feedback_pos["senders"]
ts_feedback_pos_y = dSD_feedback_pos["times"]
dSD_feedback_neg = nest.GetStatus(spikedetector_feedback_neg_y, keys="events")[0]
evs_feedback_neg_y = dSD_feedback_neg["senders"]
ts_feedback_neg_y = dSD_feedback_neg["times"]

dSD_state_pos = nest.GetStatus(spikedetector_state_pos_y, keys="events")[0]
evs_state_pos_y = dSD_state_pos["senders"]
ts_state_pos_y = dSD_state_pos["times"]
dSD_state_neg = nest.GetStatus(spikedetector_state_neg_y, keys="events")[0]
evs_state_neg_y = dSD_state_neg["senders"]
ts_state_neg_y = dSD_state_neg["times"]
...
y_min = np.min(evs_cer_neg_y)
y = [i-y_min for i in evs_cer_neg_y]
plt.figure(figsize=(10,8))
plt.scatter(ts_cer_neg_y, y, marker='.', color='blue')
y = [i-y_min for i in evs_cer_pos_y]
plt.scatter(ts_cer_pos_y, y, marker='.', color='red')
plt.xticks(ticks=np.linspace(0, n_trial*trial_len, 5),fontsize=25)
plt.yticks(fontsize=25)
plt.title('Scatter plot Cerebellum Y', size =25)
plt.xlabel('Time [ms]', size = 25)
plt.ylabel('Neuron ID', size = 25)
plt.savefig(figure_folder+'Scatter plot cerebellum Y.svg')
...
delta_t = 20
for i in range(0,trial_len*n_trial,delta_t):
    n_spikes = len([k for k in ts_cer_pos_y if k<i+delta_t and k>=i])
    freq = n_spikes/(delta_t/1000*(n_neurons/2))
    x.append(freq)
cerebellar_prediction_pos_y = x
plt.plot(range(0,trial_len*n_trial,delta_t), x, color='red')
x = []
delta_t = 20
for i in range(0,trial_len*n_trial,delta_t):
    n_spikes = len([k for k in ts_cer_neg_y if k<i+delta_t and k>=i])
    freq = n_spikes/(delta_t/1000*(n_neurons/2))
    x.append(freq)
cerebellar_prediction_neg_y = x
plt.plot(range(0,trial_len*n_trial,delta_t), x, color='blue')
plt.title('Spike frequency Cerebellum Y', size =25)
plt.xticks(ticks=np.linspace(0, n_trial*trial_len, 5),fontsize=25)
plt.yticks(fontsize=25)
plt.xlabel('Time [ms]', size =25)
plt.ylabel('Frequency [Hz]', size =25)
...
lims = ax.get_ylim()
ax.set_ylim([0,lims[1]])
plt.savefig(figure_folder+'Spike frequency cerebellum Y.svg')
...
y_min = np.min(evs_feedback_neg_y)
y = [i-y_min for i in evs_feedback_neg_y]
plt.figure(figsize=(10,8))
plt.scatter(ts_feedback_neg_y, y, marker='.', color='blue')
y = [i-y_min for i in evs_feedback_pos_y]
plt.scatter(ts_feedback_pos_y, y, marker='.', color='red')
plt.xticks(ticks=np.linspace(0, n_trial*trial_len, 5),fontsize=25)
plt.yticks(fontsize=25)
plt.title('Scatter plot sensory feedback Y', size =25)
plt.xlabel('Time [ms]', size = 25)
plt.ylabel('Neuron ID', size = 25)
plt.savefig(figure_folder+'Scatter plot sensory feedback Y.svg')
...
x_neg = []
feedback_signal_y = []
feedback_signal_pos_y = []
feedback_signal_neg_y = []
delta_t = 20
for i in range(0,trial_len*n_trial,delta_t):
    n_spikes_pos = len([k for k in ts_feedback_pos_y if k<i+delta_t and k>=i])
    n_spikes_neg = len([k for k in ts_feedback_neg_y if k<i+delta_t and k>=i])
    freq_pos = n_spikes_pos/(delta_t/1000*int(n_neurons/2))
    freq_neg = n_spikes_neg/(delta_t/1000*int(n_neurons/2))
    x_pos.append(freq_pos)
    x_neg.append(freq_neg)
    feedback_signal_pos_y.append(x_pos[-1])
    feedback_signal_neg_y.append(x_neg[-1])
    feedback_signal_y.append(x_pos[-1]-x_neg[-1])
plt.figure(figsize=(10,8))
plt.plot(range(0,trial_len*n_trial,delta_t), x_pos, color='red')
plt.plot(range(0,trial_len*n_trial,delta_t), x_neg, color='blue')
plt.title('Spike frequency sensory feedback Y', size =25)
plt.xticks(ticks=np.linspace(0, n_trial*trial_len, 5),fontsize=25)
plt.yticks(fontsize=25)
plt.xlabel('Time [ms]', size =25)
plt.ylabel('Frequency [Hz]', size =25)
plt.savefig(figure_folder+'Spike frequency sensory feedback Y.svg')
...
delta_t = 20
for i in range(0,trial_len*n_trial,delta_t):
    n_spikes_pos = len([k for k in ts_state_pos_y if k<i+delta_t and k>=i])
    n_spikes_neg = len([k for k in ts_state_neg_y if k<i+delta_t and k>=i])
    freq_pos = n_spikes_pos/(delta_t/1000*int(n_neurons/2))
    freq_neg = n_spikes_neg/(delta_t/1000*int(n_neurons/2))
    x_pos.append(freq_pos)
    x_neg.append(freq_neg)
    state_signal_pos_y.append(x_pos[-1])
    state_signal_neg_y.append(x_neg[-1])
    state_signal_y.append(x_pos[-1]-x_neg[-1])
plt.figure(figsize=(10,8))
plt.plot(range(0,trial_len*n_trial,delta_t), x_pos, color='red')
plt.plot(range(0,trial_len*n_trial,delta_t), x_neg, color='blue')
plt.title('Spike frequency State Estimator Y', size =25)
plt.xticks(ticks=np.linspace(0, n_trial*trial_len, 5),fontsize=25)
plt.yticks(fontsize=25)
plt.xlabel('Time [ms]', size =25)
plt.ylabel('Frequency [Hz]', size =25)
plt.savefig(figure_folder+'Spike frequency State Estimator Y.svg')
...
# Y
times_cereb = {}
ids_pos_cereb = cerebellar_neurons_p_y
for id_value in ids_pos_cereb:
    times_cereb[id_value] = [t for i,t in enumerate(ts_cer_pos_y) if evs_cer_pos_y[i] == id_value]
ids_neg_cereb = cerebellar_neurons_n_y
for id_value in ids_neg_cereb:
    times_cereb[id_value] = [t for i,t in enumerate(ts_cer_neg_y) if evs_cer_neg_y[i] == id_value]
...
plt.xlabel('Time [ms]', size =25)
plt.grid(True)
plt.title('Variability of the cerebellar prediction Y', size =25)
plt.savefig(figure_folder+'Variability of the cerebellar prediction Y.svg')
variability_cer_pos_y = np.concatenate((np.arange(0,trial_len*n_trial,delta_t), reliability_pred_pos))
np.save(data_folder+"variability_cer_pos_y", variability_cer_pos_y)
variability_cer_neg_y = np.concatenate((np.arange(0,trial_len*n_trial,delta_t), reliability_pred_neg))
np.save(data_folder+"variability_cer_neg_y", variability_cer_neg_y)
...
# Y
times_feedback = {}
ids_pos_feedback = feedback_neurons_p_y
for id_value in ids_pos_feedback:
    times_feedback[id_value] = [t for i,t in enumerate(ts_feedback_pos_y) if evs_feedback_pos_y[i] == id_value]
ids_neg_feedback = feedback_neurons_n_y
for id_value in ids_neg_feedback:
    times_feedback[id_value] = [t for i,t in enumerate(ts_feedback_neg_y) if evs_feedback_neg_y[i] == id_value]
...
ax_fbk.set_ylim([0, max(lims_pred[1], lims_fbk[1])])
ax_pred.set_ylim([0, max(lims_pred[1], lims_fbk[1])])
ax_pred.figure.savefig(figure_folder+'Variability of the sensory feedback Y.svg')
plt.ylabel('Variability of the firing rates [Hz]', size =25)
plt.xlabel('Time [ms]', size =25)
plt.title('Variability of the sensory feedback Y', size =25)
plt.grid(True)
plt.savefig(figure_folder+'Variability of the sensory feedback Y.svg')
variability_feedback_pos_y = np.concatenate((np.arange(0,trial_len*n_trial,delta_t), reliability_feedback_pos))
np.save(data_folder+"variability_fbk_pos_y", variability_feedback_pos_y)
variability_feedback_neg_y = np.concatenate((np.arange(0,trial_len*n_trial,delta_t), reliability_feedback_neg))
np.save(data_folder+"variability_fbk_neg_y", variability_feedback_neg_y)
...
# Y
feedback_signal_pos_y = np.array(feedback_signal_pos_y)
feedback_signal_neg_y = np.array(feedback_signal_neg_y)
cerebellar_prediction_pos_y = np.array(cerebellar_prediction_pos_y)
cerebellar_prediction_neg_y = np.array(cerebellar_prediction_neg_y)
state_signal_pos_y = np.array(state_signal_pos_y)
state_signal_neg_y = np.array(state_signal_neg_y)
np.save(data_folder+"feedback_signal_pos_y", feedback_signal_pos_y)
np.save(data_folder+"feedback_signal_neg_y", feedback_signal_neg_y)
np.save(data_folder+"cerebellar_prediction_pos_y", cerebellar_prediction_pos_y)
np.save(data_folder+"cerebellar_prediction_neg_y", cerebellar_prediction_neg_y)
np.save(data_folder+"state_signal_pos_y", state_signal_pos_y)
np.save(data_folder+"state_signal_neg_y", state_signal_neg_y)
...
plt.figure(figsize=(12,8))
#plt.plot(np.arange(0,trial_len*n_trial,20), outputs, label='State', linewidth=5)
plt.plot(np.arange(0,trial_len*n_trial,20), feedback_signal_pos_y - feedback_signal_neg_y, label='Feedback diff', color='gold', linewidth=5)
plt.plot(np.arange(0,trial_len*n_trial,20), cerebellar_prediction_pos_y - cerebellar_prediction_neg_y, label='Cerebellum diff', color='saddlebrown', linewidth=5)
plt.plot(np.arange(0,trial_len*n_trial,20), state_signal_pos_y - state_signal_neg_y, label='State Estimator', color='b', linewidth=5)
plt.xticks(ticks=np.linspace(0, n_trial*trial_len, 5),fontsize=25)
plt.yticks(fontsize=25)
plt.ylabel('Firing rate [Hz]', size = 25)
plt.xlabel('Time [ms]', size = 25)
plt.title('Bayesian integration of prediction and sensory feedback Y', size =25)
plt.savefig(figure_folder+'Bayesian integration of prediction and sensory feedback Y.svg')
